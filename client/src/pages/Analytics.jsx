    ...
    return (
      <DashboardLayout>
        <div className="page-enter analytics-page">
          <div
            className="usage-banner usage-banner-info"
          ...
          <div className="pro-empty-state">
            ...
            <p>
              Upgrade to see your application trends, interview rates, and
              resume performance.
            </p>
      ...
      <div className="page-enter analytics-page">
            ...
            {overview === null ? (
              <>
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="analytics-stat-box skeleton"
                    style={{ height: 80 }}
                  />
                ))}
              </>
        ...
        <section className="analytics-section">
          ...
          <div style={{ position: "relative", display: "inline-block" }}>
            <CoachMark
              id="analytics_first_visit"
              title="Your application pipeline"
              body="This bar shows where all your applications stand. Come back weekly — it updates as you track more."
              show={true}
              position="bottom"
              delay={1000}
            />
        ...
        <section className="analytics-section">
          ...
          {trends === null ? (
            ...
            <p className="analytics-empty">
              No trend data yet. Add applications to see your activity over
              time.
            </p>
          ) : (
              ...
              <div className="bar-chart">
                {trends.map((t) => (
                  <div
                    ...
                    title={`Week ${formatWeekLabel(t.week)}: ${t.count} applications`}>
              ...
              <tbody>
                {tableData.map((row) => (
                  <tr key={row.key}>
                    ...
                    <td>
                      <span className={getRatePillClass(row.rate)}>
                        {row.rate}%
                      </span>
                    </td>
                  </tr>
              ...
              {[...resumes]
                ...
                .map((r) => (
                  <div key={r._id} className="score-history-row stagger-item">
                    <span className="score-history-label">
                      {r.label || "Resume"}
                    </span>
